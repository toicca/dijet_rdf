...
namespace std {
  ...
  struct hash<JME::Binning> {
    ...
    // Function encapsulating static instance
    // Something like this to fix the binning to string issue
    const JME::bimap<JME::Binning, std::string>& getBinningToStringMap() {
    static const JME::bimap<JME::Binning, std::string> binning_to_string = {
        {JME::Binning::JetPt, "JetPt"},
        {JME::Binning::JetEta, "JetEta"},
        {JME::Binning::JetAbsEta, "JetAbsEta"},
        {JME::Binning::JetE, "JetE"},
        {JME::Binning::JetArea, "JetArea"},
        {JME::Binning::Mu, "Mu"},
        {JME::Binning::Rho, "Rho"},
        {JME::Binning::NPV, "NPV"}
    };
    return binning_to_string;
    }
