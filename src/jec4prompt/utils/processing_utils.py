...
def get_bins(fill_range : tuple = (376370, 380100), isMC : bool = False) -> dict:
    ...
    bins["dpt"] = {}
    bins["dpt"]["bins"] = np.array((10, 15, 20, 25, 30, 35, 40, 50, 60, 70, 85, 100, 125, 155, 180, 210, 250, 300, 350, 400, 500, 600, 800, 1000, 1200, 1500, 1800, 2100, 2400, 2700, 3000, 3500, 4000, 5000), dtype=float)
    ...
    bins["sresp_pt"] = {}
    bins["sresp_pt"]["bins"] = np.array((15, 21, 28, 37, 49,
    59, 86, 110, 132, 170, 204, 236, 279, 302, 373, 460, 575,
    638, 737, 846, 967, 1101, 1248,
